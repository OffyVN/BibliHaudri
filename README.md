...
titre par OCR), indiquer sa disponibilité, son prix et où le trouver. Site statique (`index.html`)
à voir via GitHub Pages ; données et photos partagées via Supabase (voir `GUIDE-MISE-EN-LIGNE.md`).
